...
The automatic inference takes us only so far, usually we nee more control over the parameter. `plac` offers simple decorator helpers for positional, option and flag type parameters:
